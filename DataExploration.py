...
print ('sample of 25%',rows)#The original code was missing () for print
...
SumofAge=df['age'].sum()
print ('Sum of Ages', SumofAge)#Original code was missing () for print

MeanAge = df['age'].mean()
print ('Average Ages', MeanAge)#Original code waas missing () for print
# Find the mean of all columns
print ('Means of each column', df.mean(axis=0))
# Describe the Data
print (df['iq'].describe())#Original code was missing () for print
